...
MXQ5=(5bit 5.00 5.02 5.04 5.06 5.08 5.10 5.12 5.14 5.16 5.18 5.20 5.22 5.24 5.26 5.28 5.30 5.32 5.34 5.36 5.38 5.40 5.42 5.44 5.46 5.48 5.50 5.52 5.54 5.56 5.58 5.60 5.62 5.64 5.66 5.68 5.70 5.72 5.74 5.76 5.78 5.80 5.82 5.84 5.86 5.88 5.90 5.92 5.94 5.96 5.98)
...
MXQ_BATCHES=(MXQ4 MXQ5 MXQ6 MXQ7)
declare -n MXQ_BATCH
...
for MXQ_BATCH in "${MXQ_BATCHES[@]}"; do
  ...
  python ../src/cli.py dump \
      ...
      --output_file "$RESULT_DIR/$EXP_BASE_NAME/data/mxq-quant-cfgs-${EXP_NAME}.csv" \
      2>&1 \
      | tee -a $log_file
