...
p11 <- weight_grid(df_disp, "mlp.down_proj", NULL, bar_value_fnorm)
p12 <- weight_grid(df_disp, "mlp.down_proj", attempt1, bar_value_fnorm)
p13 <- weight_grid(df_disp, "mlp.down_proj", attempt2, bar_value_fnorm)

p21 <- weight_grid(df_disp, "mlp.gate_proj", NULL, bar_value_fnorm)
p22 <- weight_grid(df_disp, "mlp.gate_proj", attempt1, bar_value_fnorm)
p23 <- weight_grid(df_disp, "mlp.gate_proj", attempt2, bar_value_fnorm)

p31 <- weight_grid(df_disp, "mlp.up_proj", NULL, bar_value_fnorm)
p32 <- weight_grid(df_disp, "mlp.up_proj", attempt1, bar_value_fnorm)
p33 <- weight_grid(df_disp, "mlp.up_proj", attempt2, bar_value_fnorm)
...
p61 <- weight_grid(df_disp, "self_attn.k_proj", NULL, bar_value_fnorm)
p62 <- weight_grid(df_disp, "self_attn.k_proj", attempt1, bar_value_fnorm)
p63 <- weight_grid(df_disp, "self_attn.k_proj", attempt2, bar_value_fnorm)

p71 <- weight_grid(df_disp, "self_attn.o_proj", NULL, bar_value_fnorm)
p72 <- weight_grid(df_disp, "self_attn.o_proj", attempt1, bar_value_fnorm)
p73 <- weight_grid(df_disp, "self_attn.o_proj", attempt2, bar_value_fnorm)

p81 <- weight_grid(df_disp, "self_attn.q_proj", NULL, bar_value_fnorm)
p82 <- weight_grid(df_disp, "self_attn.q_proj", attempt1, bar_value_fnorm)
p83 <- weight_grid(df_disp, "self_attn.q_proj", attempt2, bar_value_fnorm)

p91 <- weight_grid(df_disp, "self_attn.v_proj", NULL, bar_value_fnorm)
p92 <- weight_grid(df_disp, "self_attn.v_proj", attempt1, bar_value_fnorm)
p93 <- weight_grid(df_disp, "self_attn.v_proj", attempt2, bar_value_fnorm)
